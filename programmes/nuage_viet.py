...
dump_file = SCRIPT_DIR.parent / 'pals' / 'corpus_Viet.txt'
stopwords_file = SCRIPT_DIR / 'stopwords_viet.txt'
...
output_file = images_dir / 'nuage-mots-viet.png'
...
# --- Extraction des mots vietnamien complets ---
# \p{Latin}+ couvre tous les caractères vietnamiens, utilisé avec le module regex afin de pouvoir utiliser les expression plus unicode
words = re.findall(r'\p{Latin}+', text)
